export const getMarkerSvg = (type: string, level: number, features?: any) => {
  ...
  if (isPrivateParking) {
    ...
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
        <rect x="3.5" y="3.5" width="33" height="33" rx="11" fill="${color}" stroke="#ffffff" stroke-width="1.3"/>
        <circle cx="20" cy="20" r="12.5" fill="#ffffff"/>
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="46" viewBox="0 0 36 46">
      <path fill="${color}" stroke="#ffffff" stroke-width="1.3" d="M18 0C8.1 0 0 8.1 0 18c0 13.5 16.5 26.5 17.1 27.1a1.2 1.2 0 0 0 1.8 0c.6-.6 17.1-13.6 17.1-27.1C36 8.1 27.9 0 18 0z"/>
