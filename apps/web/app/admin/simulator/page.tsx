    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 flex-shrink-0">
          <div>
            <h2 className="text-xl font-bold text-slate-800">TTTV 알고리즘 관제소</h2>
            <p className="text-xs text-slate-500 mt-0.5">추천 알고리즘(Preference, Time Cost, Incentive) 가중치 시뮬레이션 및 다봉 분포 분석</p>
          </div>
        </header>
