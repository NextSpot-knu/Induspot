...
const DEMO_TICKETS: Ticket[] = [
  { id: 'demo-1', user: '김현수', type: '혼잡도 오류 신고', title: '점심시간 중앙식당 혼잡도가 실제와 달라요', content: '12시쯤 갔는데 앱에서는 여유라고 떴는데 실제로는 만석이었습니다. 확인 부탁드립니다.', status: 'new', time: '8분 전' },
  { id: 'demo-2', user: '이지은', type: '기능 문의', title: '주차장 빈자리 알림 받을 수 있나요?', content: 'B2 주차타워 빈자리가 생기면 푸시 알림을 받고 싶은데 설정 방법이 있을까요?', status: 'new', time: '32분 전' },
  { id: 'demo-3', user: '박서준', type: '계정 문의', title: '사번 변경 후 로그인이 안 됩니다', content: '부서 이동으로 사번이 바뀌었는데 기존 계정으로 로그인이 안 됩니다.', status: 'in_progress', time: '2시간 전' },
  { id: 'demo-4', user: '정민아', type: '칭찬/제안', title: '대체 시설 추천 기능 정말 편리해요', content: '식당이 혼잡할 때 근처 카페테리아를 추천해주는 기능 덕분에 점심시간이 훨씬 여유로워졌어요. 감사합니다!', status: 'resolved', time: '어제' },
];
