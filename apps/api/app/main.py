...
from app.routers import recommendations, infrastructures, predict, ingest, preferences, forecast, diagnostics
...
app.include_router(diagnostics.router)  # GET /api/v1/diagnostics: GCP 백엔드 라이브/와이어링 self-report
